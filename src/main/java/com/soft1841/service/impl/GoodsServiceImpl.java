...
public class GoodsServiceImpl implements GoodsService {
    ...
    public List<Goods> getGoodsById(long id) {
        ...
        try{
            ...
            System.out.println("通过id查询商品出现异常");
        }
        return goodsList;
    }
    ...
    public void updateGoods(Goods goods) {
        try{
            ...
            System.out.println("更新商品信息出现的异常");
        }
    ...
    public List<Goods> getGoodsLike(String keywords) {
        ...
        try{
            ...
            System.out.println("根据关键字查询商品信息出现异常");
        }
        return goodsList;
    }
    ...
    public List<Goods> getGoodsByTypeId(long typeId) {
        ...
        try{
            ...
            System.out.println("通过类别增加商品出现异常");
        }
        return goodsList;
    }
